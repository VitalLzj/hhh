 ...
 * 邮箱：976623696@qq.com
 */
public class HomeTitle3Fragment extends BaseViewpagerFragment {
    ...
    public static HomeTitle3Fragment newInstance(String type) {

        Bundle args = new Bundle();
        args.putString("TYPE", type);
        HomeTitle3Fragment fragment = new HomeTitle3Fragment();
    ...
    private void requestLoadData(int now_page) {
        JavaBeanRequest<Home_News> request = new JavaBeanRequest<>(IpUtil.getHomeNews + "nav=3&page=" + now_page, Home_News.class);
        request(2, request, callback, false, false);
    }

    //刷新数据
    private void requestData() {
        JavaBeanRequest<Home_News> request = new JavaBeanRequest<>(IpUtil.getHomeNews + "nav=3&page=" + 1, Home_News.class);
