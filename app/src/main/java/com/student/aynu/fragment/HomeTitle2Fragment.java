 ...
 * 邮箱：976623696@qq.com
 */
public class HomeTitle2Fragment extends BaseViewpagerFragment {
    ...
    public static HomeTitle2Fragment newInstance(String type) {

        Bundle args = new Bundle();
        args.putString("TYPE", type);
        HomeTitle2Fragment fragment = new HomeTitle2Fragment();
    ...
    private void requestLoadData(int now_page) {
        JavaBeanRequest<Home_News> request = new JavaBeanRequest<>(IpUtil.getHomeNews + "nav=2&page=" + now_page, Home_News.class);
        request(2, request, callback, false, false);
    }

    //刷新数据
    private void requestData() {
        JavaBeanRequest<Home_News> request = new JavaBeanRequest<>(IpUtil.getHomeNews + "nav=2&page=" + 1, Home_News.class);
