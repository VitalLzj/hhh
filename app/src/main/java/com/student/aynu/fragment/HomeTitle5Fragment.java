 ...
 * 邮箱：976623696@qq.com
 */
public class HomeTitle5Fragment extends BaseViewpagerFragment {
    ...
    public static HomeTitle5Fragment newInstance(String type) {

        Bundle args = new Bundle();
        args.putString("TYPE", type);
        HomeTitle5Fragment fragment = new HomeTitle5Fragment();
    ...
    private void requestLoadData(int now_page) {
        JavaBeanRequest<Home_News> request = new JavaBeanRequest<>(IpUtil.getHomeNews + "nav=5&page=" + now_page, Home_News.class);
        request(2, request, callback, false, false);
    }

    //刷新数据
    private void requestData() {
        JavaBeanRequest<Home_News> request = new JavaBeanRequest<>(IpUtil.getHomeNews + "nav=5&page=" + 1, Home_News.class);
