 ...
 */
public class StudentXnAdapter extends BaseAdapter {

    private List<Student.DataBean> mLists;
    private LayoutInflater mInflater;

    public StudentXnAdapter(Context mContext, List<Student.DataBean> mLists) {
        this.mLists = mLists;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        holder.mText.setText(mLists.get(i).getXntext());
        return view;
    }
